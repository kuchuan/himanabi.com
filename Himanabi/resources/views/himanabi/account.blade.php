...
{{-- <form action="{{ route('himanabi.account', ['id' => Auth::user()->id]) }}" method="POST"> --}}
<form action="{{ route('himanabi.account') }}" method="POST">
@csrf
            ...
            <div class="col-sm-10 my-md-5 rounded p-3 shadow-sm" style="background-color:#FFFFCC"><!--中央パート-->
                ...
                <div class="col-5"><!--中央パートの左側-->
                                ...
                                <div class="form-group text-left">
                                    <label class="small text-info" for="textArea1">希望期間</label>
                                        <div class="input-group mb-3">
                                          <input type="number" class="form-control" placeholder="期間を記入してください" aria-label="希望期間" aria-describedby="skills_get" value="{{ old('skills_get',$datas->skills_get) }}">
                          ...
                          <div class="form-group text-left">
                            ...
                            <textarea class="form-control" name="skills_enthusiasm" id="skills_enthusiasm" rows="3">{{ old('skills_enthusiasm',$datas->skills_enthusiasm) }}</textarea>
                          </div>
                </div>{{-- 中央パートの左側 --}}
