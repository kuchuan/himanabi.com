                          ...
                          <div class="modal-content"><!--./Modalcontent-->
                            ...
                            <div class="modal-body">
                              ...
                              @csrf
                                ...
                                <div>
                                  <p style="margin:20px;"><button type="button-center" class="btn btn-primary" action= "{{ route('himanabi.account')}}">{{ __('Login(普段はこちら)') }}</button></p><br>
                              ...
                              <p style="margin:20px;"><button type="button-center" class="btn btn-outline-primary">SNSのユーザーでログインする</button></p>

                              <p style="margin:20px;"><button type="button-center" class="btn btn-outline-primary">新規にユーザー登録する</button></p>
