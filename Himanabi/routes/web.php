...
// Route::group(['middleware'=>'auth'],function(){ //ここは後日有効にします
		...
		Route::get('himanabi/accountcreate', 'HimanabiController@accountcreate')->name('himanabi.accountcreate');//新規登録
		Route::post('himanabi/accountcreate', 'HimanabiController@store')->name('himanabi.accountcreate');//新規保存
		Route::get('himanabi/accountedit', 'HimanabiController@accountedit')->name('himanabi.accountedit');//ユーザー編集
		Route::post('himanabi/accountedit/', 'HimanabiController@store')->name('himanabi.accountedit');//ユーザー保存


		Route::get('himanabi/skillcreate', 'HimanabiController@skillcreate')->name('himanabi.skillcreate');//スキル新規登録
		Route::get('himanabi/skilledit', 'HimanabiController@skilledit')->name('himanabi.skilledit');//スキル編集
		Route::get('himanabi/skillcheck','HimanabiController@skillcheck')->name('himanabi.skillcheck');//提供スキルカード確認
		Route::put('himanabi/skillupdate', 'HimanabiController@skillupdate')->name('himanabi.skillupdate'); //カードからスキル更新処理


		Route::get('himanabi/skilllist','HimanabiController@skilllist')->name('himanabi.skilllist');//スキルリスト
